...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onStartGame(View view) {
        ...
        ViewGroup w1 = (ViewGroup) findViewById(R.id.word1);
        ViewGroup w2 = (ViewGroup) findViewById(R.id.word2);
        w1.removeAllViews();
        w2.removeAllViews();
        try {
            stackedLayout.clear();
        ...
        String scrambled = "";
        int c1 = 0, c2 = 0, index1 = 0, index2 = 0;
        char ch = '\0';
        TextView messageBox = (TextView) findViewById(R.id.message_box);
        ...
        while (c1 != word1.length() || c2 != word2.length()) {
            ...
            if (r == 0 && c1 != word1.length()) {
                scrambled = scrambled + word1.charAt(index1);
                c1++;
                index1++;

            }
            if (r == 1 && c2 != word2.length()) {
                scrambled = scrambled + word2.charAt(index2);
                c2++;
                index2++;
            }
        ...
        while (l > 0) {
            obj = new LetterTile(this, scrambled.charAt(l - 1));
            stackedLayout.push(obj);
            l--;
        }
        return true;
    ...
    protected void checkWin() {
        Toast.makeText(this,word1 + " "+word2,Toast.LENGTH_LONG).show();
        TextView messageBox = (TextView) findViewById(R.id.message_box);
